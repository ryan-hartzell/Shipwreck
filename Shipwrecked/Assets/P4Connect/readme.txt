...
Release Notes:
Last Update : September 15, 2016 by Norman Morse 
...
Documentation
-------------
https://www.perforce.com/perforce/doc.current/manuals/p4connectguide/index.html
https://www.perforce.com/resources/tutorials/installing-configuring-p4connect-unity
...
-------------
Version 2017.1
- Fixed initialization of Config class which was causing problems in Unity 5.4+
- Disable Perforce updates while game is running
- Cleaned up P4Bridge project file linkage to C++ API.

Version 2016.2 Patch 2/1441885
- Added P4Connect.Skin class
- Fixed problems in changemanager involving empty changes
- Renamed ChangeLists to ChangeListsWindow
- Improved ChangeListsWindow (debug build only)

Version 2016.2 Patch 1/1430474
- fixed more issues with relocating P4Connect into a subdirectory under Assets (Configuration Assets work now)
- Inactivate Back button on first page of Wizard
- Denote required fields in Connection Settings
- reworked AssetStatus Cache, reduced number of fstats being issued.
- fixed project window updates and menus 
- updated Pending Changes dialog and associated menus
- added P4API.NET support for reconcile command
- fixed some initialization and restart issues
- fixed project file Hint paths for Unity Assemblies

Version 2016.2/1385874
- dropped support for Unity 4
- Fixed issues with Configuration dialog popping up between runs.
- Fixed problems with assemblies being "mismarked"
- Built using Unity5, to remove the "incompatibility" warning in the asset store.
- Other minor bug fixes and optimizations.

Version 2016.1 Patch2/1375274
- fixed issues with relocating P4Connect into a subdirectory under Assets
- fixed problems loading icons in Unity 5.3.0p1 or above
- cleaned up restoring connection after run
- cache last good connection to speed up reconnect process.
- changed "Show Commands" option to "Echo P4 commands to log".
- changed default log locations to be in same directory as unity logs.
- Errors during a command will only return one log entry with the Error and command context.
- Added Protocol option to wizard,  fixed some minor bugs in wizard.

Version 2016.1 Patch1/1364173
- fixed Broken SSL connections
- Added Trust dialog for setting up SSL connections
- removed some debugging output.
- limited user and workspace pop-ups to 20 entries.

Version 2016.1/1357678
- Fixed "Bad Settings, Please Fix" annoyance.  It doesn't needlessly retry 3 times any more.
- Login and ticket generation improved, interoperability with P4V and P4VS ticket files.
- Added Connection Wizard which allows:
   * View List of Users on Server
   * Create new User on Server
   * View List of Workspaces on Server
   * Create new Workspace on Server
- Added Password Dialog which pops up when a password is incorrect or users login has expired.
- Added custom GUIStyle for P4Connect with colored buttons.

Version 2015.3 Patch1/1311537
